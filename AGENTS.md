# AGENTS.md - tasky AI Agent Configuration

This document provides guidance for AI agents working with the tasky project, including development setup, testing, and code quality standards.

## Project Overview

tasky is a project management platform with conversational AI task execution. It's built as a monorepo with:
...
DATABASE_URL="postgresql://tasky:tasky@localhost:5432/tasky"
...
When working on tasky as an AI agent:
...
- GitHub Issues: https://github.com/tasky/tasky/issues
- GitHub Discussions: https://github.com/tasky/tasky/discussions
